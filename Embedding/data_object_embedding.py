...
class DataObject:
    ...
    def combine(self, customer_vector, note_vector=None, transaction_vector=None, weights=None):
        """
        ...
        if note_vector is not None:
            vectors.append(self.normalize_vector(note_vector))
        if transaction_vector is not None:
            vectors.append(self.normalize_vector(transaction_vector))
